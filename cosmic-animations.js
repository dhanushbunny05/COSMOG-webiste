...
(function() {
    ...
    const initHeroAnimations = () => {
        ...
        // Hero background orbs animation
    ...
    const initCosmicEventsAnimations = () => {
        console.log('🎠 Initializing Cosmic Events Animations...');

        // Events section entrance
        gsap.fromTo('.cosmic-events-title', {
            y: 100,
            opacity: 0,
            scale: 0.8
        }, {
            ...
            ease: 'power3.out',
            scrollTrigger: {
                trigger: '.cosmic-events-section',
                start: 'top 80%',
                toggleActions: 'play none none reverse'
            }
        });

        gsap.fromTo('.cosmic-events-subtitle', {
            y: 50,
            opacity: 0
        }, {
            y: 0,
        ...
        // Carousel cards entrance animation
        gsap.fromTo('.cosmic-event-card', {
            y: 100,
            opacity: 0,
            scale: 0.8,
            rotationY: 25
            ...
            ease: 'power2.out',
            scrollTrigger: {
                trigger: '.cosmic-events-carousel',
                start: 'top 70%',
                toggleActions: 'play none none reverse'
            }
        });
    ...
    const initScrollProgress = () => {
        ...
        progressLine.style.cssText = `
            height: 100%;
            background: linear-gradient(90deg, var(--cosmic-cyan), var(--cosmic-purple), var(--cosmic-pink));
            width: 0%;
