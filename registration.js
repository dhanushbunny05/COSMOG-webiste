document.addEventListener('DOMContentLoaded', () => {
    ...
    // UPDATED: Event details database with your new content
    const eventDetails = {
        "Web Craft": {
            ...
            rules: [
                "Participants must bring their own laptops, mobile devices, internet connections (hotspot/dongle), and required cables or chargers.",
                "The organizing team will not provide technical equipment.",
                "The website must be created using only two AI platforms/tools. One of these will be mandatorily suggested by the Event Head.",
                "The suggested AI platform will have a limited number of prompts; participants must use them wisely.",
                "A team may consist of 1 to 4 members.",
                "Only registered participants are allowed to work on the project; no external help is permitted.",
                "Evaluation is based on Creativity, Effective Use of AI, Design & UX, and Team Collaboration."
            ]
        },
        "Art Attack": {
            ...
            rules: [
                "Bring Your Supplies: Artists must bring their own drawing and painting materials. Only the A4 paper will be provided.",
                "Time Limit: The competition is strictly 45 minutes. Late submissions will not be accepted.",
                "Original Work Only: All artwork must be created on the spot. Any form of copying or using pre-made work will lead to immediate disqualification.",
                "No Electronic Devices: The use of mobile phones or any other electronic devices is strictly prohibited during the competition.",
                "Fair Play: All participants are expected to maintain discipline and respect their fellow contestants to ensure a fair and fun competition for everyone."
            ]
        },
        "TreQueza": {
            ...
            rules : [
                ...
                "question in each round, will cover multiple categories",
                "Difficulty increases with each round",
                "Mobile phones and electronic devices or Using AI during the event are strictly prohibited.",
                "Cheating is not allowed to ensure a fair and healthy competition, any violation will result in instant elimination."
            ]
        },
        "Capture and Creative": {
            ...
            rules : [
                "Fresh footage captured during the event is allowed previously recorded clips or stock footage will lead to disqualification",
                "Participant must use your phone device(mobile/ camera/ laptop) and editing tools.",
                "The content should be appropriate, respectful and align with the theme of promoting the college",
                "Creativity, storytelling, technical editing, and overall presentation will be the key judging criteria",
                "All final submissions must be made within the given time limit late entries will not be acceptable."
            ]
        },
        "Mission Impossible": {
            ...
            rules: [
                "Team Size: 4 members.",
                "No mobile phones or AI may be used; violation will lead to immediate disqualification.",
                "Misusing permissions given by the crew during tasks will result in elimination.",
                "Cheating in any round leads to direct elimination.",
        ...
        "Game-On (BGMI)": {
            ...
            rules: [
                "This competition is for BGMI (Battlegrounds Mobile India) only.",
                "Participants must use their own mobile devices; no external devices will be provided.",
                "Both solo and squad formats have separate prize categories.",
                "A squad can have a maximum of 4 members.",
                "No substitutes are allowed once a match begins.",
                "Players must join the game lobby on time; late entries will not be allowed.",
                "Any form of cheating, hacking, or unfair play will result in disqualification."
            ]
        },
        "Game-On (Free Fire)": {
            overview: "Game-On brings the thrill of competitive gaming to campus! Gear up for intense battles in Free Fire, where reflexes, strategy, and survival skills will decide the champions.<br><br><b>Event Format:</b> The event consists of a Qualification Round held in two slots, with the top 5 teams from each slot advancing. The 10 qualified teams will then compete in the Final Round for the Winner and Runner-up titles.<br><br><b>Participation:</b> Players can compete solo or in squads of up to 4 members.",
            rules: [
                "This competition is for Free Fire only.",
                "Participants must use their own mobile devices; no external devices will be provided.",
                "Both solo and squad formats have separate prize categories.",
                "A squad can have a maximum of 4 members.",
                "No substitutes are allowed once a match begins.",
        ...
        "Glam Jam": {
            ...
            rules: [
                "Team Size: 2-4 members (Fee is per person).",
                "Fair Play: No peeking during the blindfolded game and no shouting answers during the Whisper Challenge.",
                "Team Spirit: Support your team and cheer for others.",
                "Follow Instructions: Listen carefully to the coordinators.",
                "Have Fun: Enjoy every moment!",
                "Eligibility: This event is strictly for girls only."
            ]
        },
        "Cultural Carnival": {
            ...
            rules: [
                "This event is open to all students to perform and watch.",
                "Performers can participate in multiple categories.",
                "Creativity, originality, and stage presence will be appreciated and rewarded.",
                "The main goal is to celebrate talent, have fun, and create unforgettable memories!"
            ]
        },
        "default": {
            ...
            rules: [
                    "All participants must be current students of St. Martin's Engineering College.",
                    "Team size must adhere to the limits specified for this event.",
                    "Participants must bring their own laptops and any required software unless stated otherwise.",
                    ...
                    "Please arrive at the venue at least 15 minutes before the scheduled start time."
            ]
        }
    };
    ...
    function openModal(eventName, fee, isLearnMore = false) {
        ...
        if (isLearnMore) {
            continueToFormBtn.style.display = 'none';
        } else {
            continueToFormBtn.style.display = 'block';
        }
    ...
    async function handleRegistrationSubmit(event) {
        ...
        try {
            ...
            // Generate and store the registration ID in the current session
    ...
    function initiatePayment(firestoreDocId, registrationData) {
        return new Promise((resolve, reject) => {
            ...
            if (!razorpayKey || razorpayKey === 'YOUR_RAZORPAY_KEY_ID') {
                alert('Payment gateway is not configured correctly. Please contact the event organizer.');
    ...
    async function updateRegistrationStatus(docId, status, paymentId = null, errorDetails = null) {
        try {
            ...
            if (status === 'completed') {
                // Pass the generated registration ID to the success function
    ...
    // --- MODIFIED Confirmation Function ---
    ...
    registerButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            const eventFee = e.currentTarget.dataset.eventFee;
            openModal(eventName, eventFee, false);
        });
    });
    ...
    learnMoreButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            const eventName = e.currentTarget.dataset.eventName;
            const eventFee = e.currentTarget.dataset.eventFee;
            openModal(eventName, eventFee, true);
        });
    });
    ...
    yearSelect.addEventListener('change', () => {
        if (yearSelect.value && ['1', '2', '3', '4'].includes(yearSelect.value)) {
